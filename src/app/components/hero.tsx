  ...
  return (
    <div id="home" className="relative w-full h-[85vh] text-white z-30">
      <div className="relative w-full h-full">
        ...
        {/* Adicionado 'hidden md:flex' para controlar a visibilidade das setas */}
        <div className="hero-swiper-button-prev hidden md:flex">
          <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
            <polyline points="15 18 9 12 15 6"></polyline>
          </svg>
        </div>
        
        <div className="hero-swiper-button-next hidden md:flex">
          <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
